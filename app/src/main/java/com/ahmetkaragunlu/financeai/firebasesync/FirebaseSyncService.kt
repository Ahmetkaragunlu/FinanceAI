    ...
    private suspend fun sendPendingNotifications() {
        ...
        try {
            ...
            val currentToken = try {
                ...
                Log.e(TAG, "Couldn't get FCM token for pending check", e)
            ...
            if (currentToken == null) {
                ...
                Log.e(TAG, "Token is null, cannot check pending notifications")
            ...
            Log.d(TAG, "📱 Sending current token: ${currentToken.take(10)}...") // Token'ı logla
            ...
            functions
                ...
                .addOnSuccessListener { result ->
                    ...
                    Log.d(
                        TAG,
                        "✅ Cloud Function processed $count pending notifications for this device"
                    )
            ...
            Log.e(TAG, "Error in sendPendingNotifications", e)
        ...
        try {
            ...
            snapshot.documents.forEach { doc ->
                ...
                if (existing == null) {
                    ...
                    Log.d(
                        TAG,
                        "⏭️ Transaction ALREADY EXISTS in Room, SKIPPING: $firestoreId (id=${existing.id})"
                    )
                                ...
                                when (change.type) {
                                    DocumentChange.Type.ADDED -> {
                                        ...
                                        if (recentlyAddedIds.contains(firestoreId)) {
                                            ...
                                            Log.d(
                                                TAG,
                                                "⏭️ Skipping recently added transaction: $firestoreId"
                                            )
                                        ...
                                        Log.d(
                                            TAG,
                                            "➕ Adding NEW transaction from Firebase: $firestoreId"
                                        )
                                                ...
                                                try {
                                                    ...
                                                    if (downloadResult.isSuccess) {
                                                        ...
                                                        existingTx?.let {
                                                            ...
                                                            Log.d(
                                                                TAG,
                                                                "Photo downloaded for transaction: $firestoreId"
                                                            )
                                        ...
                                        Log.d(
                                            TAG,
                                            "✅ Transaction added from listener: $firestoreId"
                                        )
                                    ...
                                    DocumentChange.Type.MODIFIED -> {
                                        ...
                                        if (existing != null) {
                                            ...
                                            Log.d(
                                                TAG,
                                                "✅ Transaction updated from Firebase: $firestoreId"
                                            )
                                    ...
                                    DocumentChange.Type.REMOVED -> {
                                        ...
                                        existing?.let {
                                            ...
                                            Log.d(
                                                TAG,
                                                "✅ Transaction deleted from local: $firestoreId"
                                            )
                                ...
                                when (change.type) {
                                    ...
                                    DocumentChange.Type.ADDED -> {
                                        ...
                                        if (recentlyAddedIds.contains(firestoreId)) {
                                            ...
                                            Log.d(
                                                TAG,
                                                "⏭️ Skipping recently added scheduled: $firestoreId"
                                            )
                                        ...
                                        if (existing != null) {
                                            ...
                                            Log.d(
                                                TAG,
                                                "⏭️ Scheduled ALREADY EXISTS in Room, SKIPPING: $firestoreId (localId=${existing.id})"
                                            )
                                        ...
                                        Log.d(
                                            TAG,
                                            "➕ Adding NEW scheduled from Firebase: $firestoreId"
                                        )
                                        ...
                                        val localId = localRepository.insertScheduledTransaction(
                                            scheduledTransaction
                                        )

                                        Log.d(
                                            TAG,
                                            "✅ Scheduled added from Firebase: $firestoreId (localId=$localId)"
                                        )
                                    ...
                                    DocumentChange.Type.MODIFIED -> {
                                        ...
                                        if (existing != null) {
                                            ...
                                            Log.d(
                                                TAG,
                                                "Scheduled updated from Firebase: $firestoreId"
                                            )
